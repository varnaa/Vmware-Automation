...
public class Main {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        basicConnection.setUrl("");
        basicConnection.setUsername("");
        basicConnection.setPassword("");
        connect.setConnection(basicConnection);
        Connection connection = connect.connect();
        System.out.println("Connected successfully :: " + connection.getServiceInstanceName());
